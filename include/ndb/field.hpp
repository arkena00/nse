...
////////////////////////////////////////////////////////////////////////////////
    ...
    public:
        struct detail
        {
            ...
            static constexpr bool is_auto_increment = has_option<field_option::autoincrement, Option>::value;
...
////////////////////////////////////////////////////////////////////////////////
    ...
    class field<T, typename std::enable_if_t<!ndb::is_table<T>>> :
        public common_field<field_base::size<default_size<T>()>, ndb::option<>>, field_base
    {
    public:
        using type = T;
        using typename common_field<field_base::size<default_size<T>()>, ndb::option<>>::Detail_;
    };
    ...
    class field<T, option<Option_code...>> :
        public common_field<field_base::size<default_size<T>()>, option<Option_code...>>, field_base
    {
    public:
        using type = T;
        using typename common_field<field_base::size<default_size<T>()>, option<Option_code...>>::Detail_;
    };
    ...
    template<class T>
    class field<T, typename std::enable_if_t<ndb::is_table<T>>> :
        public common_field<field_base::size<default_size<T>()>, option<field_option::none>>, field_base
    {
    public:
        using type = T;
        using typename common_field<field_base::size<default_size<T>()>, option<field_option::none>>::Detail_;
    };
} // ndb
