...
int main()
{
    ...
    assert_same_type(size_t_wrapper<267>{}, ndb::trait::array_size_for<db::library::movie>::type{});
    assert_same_type(size_t_wrapper<12>{}, ndb::trait::array_size_for<db::library::sound>::type{});
    assert_same_type(size_t_wrapper<279>{}, ndb::trait::array_size_for<db::library>::type{});
